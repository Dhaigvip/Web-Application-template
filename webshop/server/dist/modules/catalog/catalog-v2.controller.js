...
exports.CatalogControllerV2 = void 0;
...
let CatalogControllerV2 = class CatalogControllerV2 {
    ...
    getProduct(req, slug) {
        const includeInactive = Boolean(req.visibility?.includeInactive);
        return this.catalogService.getProductBySlug(slug, { includeInactive, apiVersion: 2 });
    }
    getCategories(req) {
        const includeInactive = Boolean(req.visibility?.includeInactive);
...
exports.CatalogControllerV2 = CatalogControllerV2;
__decorate([
...
], CatalogControllerV2.prototype, "getProducts", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CatalogControllerV2.prototype, "getProduct", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CatalogControllerV2.prototype, "getCategories", null);
exports.CatalogControllerV2 = CatalogControllerV2 = __decorate([
